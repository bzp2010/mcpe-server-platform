...
public class ServerListAdapter extends BaseQuickAdapter<ServerCardItem, ServerListAdapter.ServerListViewHolder> {

    private Context context;

    public ServerListAdapter(Context context, @Nullable List<ServerCardItem> data) {
        super(R.layout.layout_server_list_item, data);
        this.context = context;
    }

    /*public ServerListAdapter(Context context, List<ServerCardItem> models){
        this.context = context;
        this.models = models;
    }*/
    ...
    public class ServerListViewHolder extends BaseViewHolder {
