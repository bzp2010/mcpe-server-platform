...
class Publics extends Common
{
    ...
    public function login(){
        header('Location: /user/login?return_url='.urlencode('/admin.php/user/publics/signin.html'));
    }
    ...
    public function signout()
    {
        ...
        header('Location: /user/logout?return_url='.urlencode('/admin.php/user/publics/signin.html'));
    }
}
