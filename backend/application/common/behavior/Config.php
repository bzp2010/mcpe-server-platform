...
class Config
{
    ...
    public function run(&$params)
    {
        ...
        $view_replace_str = [
            // 静态资源目录
            '__STATIC__'    => 'https://svcdn.qi78.com'.PUBLIC_PATH. 'static',
            // 文件上传目录
            '__UPLOADS__'   => 'https://svcdn.qi78.com'.PUBLIC_PATH. 'uploads',
            // JS插件目录
            '__LIBS__'      => 'https://svcdn.qi78.com'.PUBLIC_PATH. 'static/libs',
            // 后台CSS目录
            '__ADMIN_CSS__' => 'https://svcdn.qi78.com'.PUBLIC_PATH. 'static/admin/css',
            // 后台JS目录
            '__ADMIN_JS__'  => 'https://svcdn.qi78.com'.PUBLIC_PATH. 'static/admin/js',
            // 后台IMG目录
            '__ADMIN_IMG__' => 'https://svcdn.qi78.com'.PUBLIC_PATH. 'static/admin/img',
            // 前台CSS目录
            '__HOME_CSS__'  => 'https://svcdn.qi78.com'.PUBLIC_PATH. 'static/home/css',
            // 前台JS目录
            '__HOME_JS__'   => 'https://svcdn.qi78.com'.PUBLIC_PATH. 'static/home/js',
            // 前台IMG目录
            '__HOME_IMG__'  => 'https://svcdn.qi78.com'.PUBLIC_PATH. 'static/home/img',
            // 表单项扩展目录
